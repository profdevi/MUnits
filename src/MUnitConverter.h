...
class MUnitConverter
	...
	double JoulesToKCalMole(const double &val);
	...
	double ElectronVoltsToKCalMole(const double &val);
	...
	double HartreeToKCalMole(const double &val);
	...
	double KelvinToKCalMole(const double &val);
	...
	double InvCentimetersToKCalMole(const double &val);

	double KCalMoleToElectronVolts(const double &val);
	double KCalMoleToHartrees(const double &val);
	double KCalMoleToKelvin(const double &val);
	double KCalMoleToJoules(const double &val);
	double KCalMoleToInvCentimeter(const double &val);
